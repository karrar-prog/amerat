...
Public Class patient2
    ...
    Sub New(id As Integer)
        ...
        Me.id = id
        Dim query As String = "select * from patient2 where id = " & id & ""
        ...
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Me.patient_id = __(ds.Tables(0).Rows(0).Item("patient_id").ToString)
    ...
    Sub New(lataer As String, blok_num As Decimal, home_num As Decimal)
        ...
        Me.id = 0
        Dim query As String = "select * from patient2 where f1 like '" & lataer & "' and f2 like '" & blok_num & "' and f3 like '" & home_num & "'"
    ...
    Private Function save_new_patient() As Boolean
        ...
        Try
            ...
            SQLCommand.CommandText = "INSERT INTO patient2(patient_id,name ,`code` , finger_print , wieght , register_date , gender ,phone ,note ,diagonosis , ref_by , f1 , f2 , f3 , f4 , f5 , f6 , f7 , f8 , f9 , f10 ,deleted,saller,house_price,first_part,last_part,first_present,last_present,water_price,is_token , token_date,lower_name , first_push_present ,first_push_amount,first_push_amount_arrived ) " +
                                                " VALUES(@patient_id,@name, @code  ,  @finger_print , @wieght ,@register_date , @gender,@phone,@note,@diagonosis,@ref_by, @f1 ,@f2 ,@f3 ,@f4 ,@f5 ,@f6 ,@f7 , @f8 ,@f9 ,@f10,@deleted,@saller,@house_price,@first_part,@last_part,@first_present,@last_present,@water_price,@is_token ,@token_date,@lower_name , @first_push_present ,@first_push_amount,@first_push_amount_arrived )"
    ...
    Public Function undelete() As Boolean
        ...
        Else
            ...
            Try
                ...
                Dim SQLCommand As New MySqlCommand()
                SQLCommand.Connection = conn
                SQLCommand.CommandText = "UPDATE  patient2 SET deleted = @deleted WHERE id = @id"
                SQLCommand.Parameters.Add("@deleted", MySqlDbType.String).Value = "0"
                SQLCommand.Parameters.Add("@id", MySqlDbType.String).Value = Me.id
    ...
    Private Function update_patient() As Boolean
        ...
        Try
            Dim SQLCommand As New MySqlCommand()
            SQLCommand.Connection = conn
            SQLCommand.CommandText = "UPDATE patient2 SET first_push_amount_arrived=@first_push_amount_arrived , name = @name , `code` = @code , finger_print = @finger_print , wieght = @wieght , gender = @gender , phone = @phone , note = @note , diagonosis = @diagonosis , ref_by = @ref_by " +
    ...
    Function findByName() As Boolean
        Me.id = id
        Dim query As String = "select * from patient2 where name like '" & Me.name & "'"
    ...
    Public Function set_virfied_fesha() As Boolean
        ...
        Try
            Dim SQLCommand As New MySqlCommand()
            SQLCommand.Connection = conn
            SQLCommand.CommandText = "UPDATE patient2 SET `code` = @code WHERE id = @id"
