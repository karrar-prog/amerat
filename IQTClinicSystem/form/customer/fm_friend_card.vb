...
Public Class fm_friend_card
    ...
    Private Sub fm_friend_card_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim filePath As String

        filePath = Application.StartupPath & "/friend_card.repx"
