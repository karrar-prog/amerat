Module doctor_controller
    ...
    Public Sub formatlist_dept_table(ByVal lv As ListView)
        ...
        lv.Columns.Add("ت", 1)
        lv.Columns.Add("العنوان", 100)
        lv.Columns.Add("المبلغ", 80)
        lv.Columns.Add("الواصل", 80)
        lv.Columns.Add("تأريخ الاستحقاق", 120)
        lv.Columns.Add("النسبة", 70)
        lv.Columns.Add("المبلغ كتابة", 220)
        lv.Columns.Add("تأريخ الانشاء", 150)
        lv.Columns.Add("رقم المستخدم", 0)
        lv.Columns.Add("", 0)
        lv.Columns.Add("", 0)
        lv.Columns.Add("", 0)
        lv.Columns.Add("", 0)
